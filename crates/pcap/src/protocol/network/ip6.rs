use anyhow::Result;
use crate::{cache::{intern, intern_ip6}, common::{concept::Field, enum_def::Protocol, io::Reader, Context, Frame}, constants::ip_protocol_type_mapper, protocol::ip4_mapper, read_field_format, read_field_format_fn};
