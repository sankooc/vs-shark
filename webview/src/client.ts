...
//   }
//   const item = new CTreeItem(packet.summary());
//   if (packet.end > packet.start) {
//     item.index = [packet.start, packet.end - packet.start];
//   }

//   for (const field of packet.getChildFields()) {
//     const str = field.summary();
//     if (!str) continue;
//     if (field.getSize()) {
//       item.addIndex(str, field.getStartIndex(), field.getSize());
//     } else {
//       item.append(str)
//     }
//   }
...
//     //     const { size, start } = field;
//     //     const str = field.summary();
//     //     if(str && str.length){
//     //       if(size) {
//     //         for(const s of str){
//     //           item.addIndex(s, start, size);
//     //         }
//     //       } else {
//     //         for(const s of str){
//     //           item.append(s)
